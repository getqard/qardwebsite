            ...
            <AnimatePresence mode="popLayout">
                ...
                >
                    {activeStep === 0 ? (
                        ...
                        <div className="absolute inset-0 w-full h-full bg-cover bg-center rounded-[2.5rem] lg:rounded-[3rem]" role="img" aria-label="Kunde hält Handy an NFC-Aufsteller zum Scannen" style={{ backgroundImage: "url('/NFCSCANHERZO.webp')" }}>
                        ...
                        <div className="w-full h-full relative flex flex-col items-center justify-end p-0">
                            ...
                            >
                                ...
                                <div className="w-full h-full relative">
                                    <img src="/step2herzo.webp" alt="Apple Wallet Install Screen" loading="lazy" className="w-full h-full object-cover object-top rounded-t-[1.8rem] lg:rounded-t-[2.2rem] bg-black" />
                                    <motion.div
                        ...
                        <div className="w-full h-full relative flex flex-col items-center justify-end p-0">
                            ...
                            >
                                <div className="w-full h-full relative">
                                    <img src="/scannprozess.webp" alt="Scan Process" loading="lazy" className="w-full h-full object-cover object-[center_30%] opacity-90 rounded-[1.6rem] lg:rounded-[2rem]" />
                        ...
                        <div className="w-full h-full relative flex flex-col items-center justify-center p-0 pt-10 lg:pt-0">
                            ...
                            >
                                ...
                                <div className="w-full h-full relative">
                                    <img src="/lockscreen-bg.webp" alt="iPhone Sperrbildschirm mit Push-Nachricht" loading="lazy" className="w-full h-full object-cover object-top rounded-[1.6rem] lg:rounded-[2rem] bg-zinc-900" />
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start gap-2 lg:gap-3">
                                            <div className="w-[30px] h-[30px] lg:w-[38px] lg:h-[38px] rounded-[7px] lg:rounded-[9px] shrink-0 flex items-center justify-center bg-[#5F462B] shadow-inner overflow-hidden mt-0.5">
                                                <img src="/cafe-milano-logo.png" alt="Café Milano Logo" loading="lazy" className="w-full h-full object-contain p-0.5" />
                                            </div>
                        ...
                        <div className="w-full h-full relative flex flex-col items-center justify-end p-0">
                            ...
                            >
                                <div className="absolute top-[8px] lg:top-[10px] left-1/2 -translate-x-1/2 w-[55px] h-[16px] lg:w-[75px] lg:h-[22px] bg-black rounded-full z-30"></div>
                                <div className="w-full h-full relative">
                                    <img src="/pramie.webp" alt="Prämie einlösen Bildschirm" loading="lazy" className="w-full h-full object-cover object-top rounded-[1.6rem] lg:rounded-[2rem] bg-black" />
                                    <motion.div
